...
![](https://www.sheshbabu.com/images/2020-rust-module-system/rust-module-system-1.png)

These 3 examples should be sufficient to explain how Rust’s module system works.

## [](https://www.sheshbabu.com/posts/rust-module-system/#Example-1 "Example 1")Example 1
...
![](https://www.sheshbabu.com/images/2020-rust-module-system/rust-module-system-2.png)
...
![](https://www.sheshbabu.com/images/2020-rust-module-system/rust-module-system-3.png)
...
## [](https://www.sheshbabu.com/posts/rust-module-system/#Example-2 "Example 2")Example 2
...
![](https://www.sheshbabu.com/images/2020-rust-module-system/rust-module-system-4.png)

We can now call a function defined in a file inside a folder.

## [](https://www.sheshbabu.com/posts/rust-module-system/#Example-3 "Example 3")Example 3
...
![](https://www.sheshbabu.com/images/2020-rust-module-system/rust-module-system-5.png)
...
## [](https://www.sheshbabu.com/posts/rust-module-system/#super "super")super
...
## [](https://www.sheshbabu.com/posts/rust-module-system/#use "use")use
...
## [](https://www.sheshbabu.com/posts/rust-module-system/#External-modules "External modules")External modules
...
- The `pub` keyword makes things public
- The `use` keyword is used to shorten the module path
- ***We don’t need to explicitly declare 3rd party modules***, just use [dependencies] in toml
...
© 2024 Sheshbabu Chinnakonda


# 另一种模式
```txt
---dds.rs: pub(crate) mod ddsdata; -> 编译器会自动去同目录下的dds/文件夹内寻找ddsdata.rs或ddsdata/mod.rs
---dds/
---dds/ddsdata.rs
```
`pub(crate)` 在这里修饰的是 `ddsdata` 这个子模块，它的可见性范围是：
- ✅ **crate 内部所有模块都能访问**：
    例如 `lib.rs` 或 crate 内的其他模块，可以通过 `crate::dds::ddsdata` 访问这个模块及其内部的公开项。
- ❌ **外部 crate 无法访问**：
    即使其他 crate 依赖了你的库，也看不到 `dds::ddsdata` 这个模块，它被完全隐藏在 crate 内部。